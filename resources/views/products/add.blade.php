...
@section('content')
  <div class="container">
    ...
    <!-- Content here -->
        <h1>{{ $page_heading }}</h1>
        <form action="{{ url('product/add') }}" method="POST" class="form-horizontal"  enctype="multipart/form-data">
            {{ csrf_field() }}
            ...
            <div class="input-group mb-3">
              ...
              <input type="text" class="form-control" name='name' placeholder="Username" aria-label="product name" aria-describedby="basic-addon1">
            </div>
